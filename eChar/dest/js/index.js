...
$(function () {
  ...
  var Table = {
     ...
     */
    _formatData: function _formatData(_index, _type) {
      var defaultArray = tableData;
      var tempItem = defaultArray[_index];
...
$(function () {
  ...
  // 图表2
  var myChart2 = echarts.init(document.getElementById("pieCt"));
  var option2 = {
    title: {
      text: '某站点用户访问来源',
      subtext: '纯属虚构',
  ...
  // 图表3
  var mySlider = echarts.init(document.getElementById("sliderCt"));
  ...
  // 图标4
  var myLineCt = echarts.init(document.getElementById("down_part"));
